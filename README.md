# S2T: Still2Team ([中文](#s2tstill2team-中文说明))
...
除了 Skill2Team，类似方向还可以继续扩展出很多工具：把人类社会、经济、企业形态和管理方面的研究推广到硅基社会。例如，`team2team` 可以用于硅基团队重组；`team2skill` 可以把 team 压缩成能在聊天页面直接运行的 skill，从而降低成本。这个过程也可以理解为对硅基团队核心流程的蒸馏和固化，让硅基团队变得更精简。
